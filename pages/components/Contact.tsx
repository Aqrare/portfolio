...
export default function Contact() {
  const { hasCopied, onCopy } = useClipboard("takumitakumi0310@gmail.com");
            ...
            >
              ...
              >
                <Flex>
                  ...
                  <Link href="https://github.com/Aqrare" isExternal>
                    <IconButton
                      mx={5}
                      aria-label="github"
                      variant="ghost"
                  ...
                  <Link href="https://twitter.com/0x_Yuzu" isExternal>
                    <IconButton
                      mx={5}
                      aria-label="twitter"
                      variant="ghost"
                      size="lg"
                      icon={<BsTwitter size="84px" />}
                      _hover={{
                        bg: "blue.500",
                        color: useColorModeValue("white", "gray.700"),
                      }}
                  ...
                  <Link
                    href="https://www.facebook.com/takumi.hosokawa.33"
                    isExternal
                  >
                    <IconButton
                      mx={5}
                  ...
                  <Link
                    href="https://www.linkedin.com/in/takumi-hosokawa-6b2537210/"
                    isExternal
                  >
                    <IconButton
                      mx={5}
                  ...
                  <Link href="https://t.me/yuzurypto" isExternal>
                    <IconButton
                      mx={5}
                      aria-label="telegram"
                      variant="ghost"
                      size="lg"
                      icon={<BsTelegram size="84px" />}
                      _hover={{
                        bg: "blue.500",
                        color: useColorModeValue("white", "gray.700"),
                      }}
